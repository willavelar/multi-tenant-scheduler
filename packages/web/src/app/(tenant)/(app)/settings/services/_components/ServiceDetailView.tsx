    ...
    <div>
      <div className="flex justify-between items-center mb-7">
        ...
        <button
          ...
          onClick={() => router.push(`/settings/services/${service.id}/edit`)}
        >
          Editar serviço
        </button>
      </div>
      ...
      <div className="flex items-center gap-3 mb-7">
        ...
        <div>
          <h2 className="m-0 mb-0.5 text-lg font-bold text-gray-900">{service.name}</h2>
          <p className="m-0 text-[13px] text-gray-500">{formatDuration(service.durationMinutes)}</p>
        </div>
      </div>
